        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              The first platform where your data gets funded. Turn your edge into rewards. Top performers get allocated.
              </p>
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center text-zinc-300">
                  <div className="w-2 h-2 bg-zinc-400 rounded-full mr-3"></div>
                  Risk-managed, efficient allocation.
                </li>
              </ul>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-green-300 font-medium text-sm">Prediction Received</span>
                      </div>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 mb-4 border border-zinc-700">
                      <div className="flex justify-between items-center mb-3">
                        <span className="text-zinc-800 text-sm">Portfolio Performance</span>
