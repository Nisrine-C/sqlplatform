          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative lg:order-2">
              ...
              <p className="text-white text-lg mb-8 leading-relaxed">
                Comprehensive analytics suite with real-time performance
                tracking, risk metrics, and attribution analysis. Make
                data-driven decisions with institutional-grade reporting.
              </p>
