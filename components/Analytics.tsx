            ...
            <div className="relative lg:order-2">
              <div className="inline-block mb-4">
                <div className="relative inline-flex items-center">
                  <div className="absolute inset-0 bg-black rounded-full border border-black z-0"></div>
                  <Badge
                    variant="outline"
                    className="z-10 border-zinc-700 text-zinc-300 px-2 py-1 text-sm font-normal"
                  >
              ...
              <p className="text-white text-lg mb-8 leading-relaxed">
                An institutional‑grade analytics engine delivering granular
                metrics, real‑time backtesting, and end‑of‑day live reporting
              </p>
